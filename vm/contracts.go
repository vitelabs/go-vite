...
var simpleContracts = map[types.Address]*precompiledContract{
	...
	types.AddressDexFund: {
		map[string]contracts.PrecompiledContractMethod{
			...
			contracts.MethodNameDexFundSetOwner:             &contracts.MethodDexFundSetOwner{},
			contracts.MethodNameDexFundConfigMineMarket:     &contracts.MethodDexFundConfigMineMarket{},
			contracts.MethodNameDexFundPledgeForVx:          &contracts.MethodDexFundPledgeForVx{},
			contracts.MethodNameDexFundPledgeForVip:         &contracts.MethodDexFundPledgeForVip{},
			contracts.MethodNameDexFundPledgeCallback:       &contracts.MethodDexFundPledgeCallback{},
			contracts.MethodNameDexFundCancelPledgeCallback: &contracts.MethodDexFundCancelPledgeCallback{},
		},
