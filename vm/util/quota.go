...
var (
	...
	viteGasTable = GasTable{
		...
		GetTokenInfoGas:                0,
		DexFundDepositGas:              1,
		DexFundWithdrawGas:             1,
		DexFundNewMarketGas:            1,
		DexFundNewOrderGas:             1,
		DexFundSettleOrdersGas:         1,
		DexFundPeriodJobGas:            1,
		DexFundPledgeForVxGas:          1,
		DexFundPledgeForVipGas:         1,
		DexFundPledgeCallbackGas:       1,
		DexFundCancelPledgeCallbackGas: 1,
		DexFundGetTokenInfoCallbackGas: 1,
		DexFundOwnerConfigGas:          1,
		DexFundOwnerConfigTradeGas:     1,
		DexFundMarketOwnerConfigGas:    1,
		DexFundTransferTokenOwnerGas:   1,
		DexFundNotifyTimeGas:           1,
		DexFundNewInviterGas:           1,
		DexFundBindInviteCodeGas:       1,
		DexFundEndorseVxMinePoolGas:    1,
		DexFundSettleMakerMinedVxGas:   1,
	}
)
