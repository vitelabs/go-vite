...
const (
	...
	[
        ...
        {"type":"function","name":"DexFundOwnerConfig", "inputs":[{"name":"operationCode","type":"int8"},{"name":"owner","type":"address"}, {"name":"timerAddress","type":"address"}, {"name":"allowMine","type":"bool"}, {"name":"tradeToken","type":"tokenId"}, {"name":"quoteToken","type":"tokenId"}, {"name":"newQuoteToken","type":"tokenId"}, {"name":"quoteTokenType","type":"int8"}]},
