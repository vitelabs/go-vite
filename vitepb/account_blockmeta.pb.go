...
func (*AccountBlockMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_blockmeta_56b12e4f3e94be95, []int{0}
}
...
func init() {
	proto.RegisterFile("vitepb/account_blockmeta.proto", fileDescriptor_account_blockmeta_56b12e4f3e94be95)
}

var fileDescriptor_account_blockmeta_56b12e4f3e94be95 = []byte{
