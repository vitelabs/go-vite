...
func (*SnapshotBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_snapshot_block_4248d8cde72f99a8, []int{0}
}
...
func init() {
	proto.RegisterFile("vitepb/snapshot_block.proto", fileDescriptor_snapshot_block_4248d8cde72f99a8)
}

var fileDescriptor_snapshot_block_4248d8cde72f99a8 = []byte{
