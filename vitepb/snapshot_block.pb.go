...
func (*SnapshotBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_snapshot_block_8afb0c6af37ea98c, []int{0}
}
...
func init() {
	proto.RegisterFile("vitepb/snapshot_block.proto", fileDescriptor_snapshot_block_8afb0c6af37ea98c)
}

var fileDescriptor_snapshot_block_8afb0c6af37ea98c = []byte{
