...
//}
//
func CreateAccountBlockHeightKey2(addr *types.Address, height uint64) []byte {
...
//}
//
func CreateConfirmHeightKey2(addr *types.Address, height uint64) []byte {
	key := make([]byte, 0, 1+types.AddressSize+8)
...
//}
//
//func CreateStorageValueKey2(address *types.Address, storageKey []byte) []byte {
...
//	return key
//}
//func CreateBalanceKey2(address types.Address, tokenTypeId types.TokenTypeId) []byte {
...
//}
//
//func CreateHistoryBalanceKey2(address types.Address, tokenTypeId types.TokenTypeId, snapshotHeight uint64) []byte {
