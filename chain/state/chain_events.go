...
func (sDB *StateDB) PrepareInsertAccountBlocks(blocks []*vm_db.VmAccountBlock) error { return nil }
func (sDB *StateDB) InsertAccountBlocks(blocks []*vm_db.VmAccountBlock) error        { return nil }
...
func (sDB *StateDB) PrepareDeleteAccountBlocks(blocks []*ledger.AccountBlock) error { return nil }

func (sDB *StateDB) DeleteAccountBlocks(blocks []*ledger.AccountBlock) error { return nil }

func (sDB *StateDB) PrepareDeleteSnapshotBlocks(chunks []*ledger.SnapshotChunk) error { return nil }
