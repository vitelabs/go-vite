...
type UserPrompter interface {
	// PromptInput displays the given prompt to the user and requests some textual data to be entered, returning the input of the user.
	PromptInput(prompt string) (string, error)

	// PromptPassword displays the given prompt to the user and requests some textual data to be entered, but one which must not be echoed out into the terminal.
...
func (p *terminalPrompter) PromptInput(prompt string) (string, error) {
	if p.supported {
		...
		// liner tries to be smart about printing the prompt and doesn't print anything if input is redirected.
