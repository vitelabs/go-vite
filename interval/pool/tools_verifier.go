...
func (accV *accountVerifier) verifyAccountData(b *common.AccountStateBlock) error {
...
*/
func (accV *accountVerifier) verifyAccount(b *accountPoolBlock, latest *common.SnapshotBlock) *poolAccountVerifyStat {
...
type poolSnapshotVerifyStat struct {
	results map[common.Address]verifier.VerifyResult
