...
func (self *branch) GetHashAndBranch(height uint64) (*common.Hash, Branch) {
...
func (self *branch) HeadHH() (uint64, common.Hash) {
	return self.headHH()
}

func (self *branch) TailHH() (uint64, common.Hash) {
	return self.tailHH()
}

func (self *branch) ContainsKnot(height uint64, hash common.Hash, flag bool) bool {
...
func (self *branch) GetHash(height uint64, flag bool) *common.Hash {
	w := self.getKnot(height, flag)
	if w == nil {
		return nil
	}
...
func (self *branch) contains(height uint64, hash common.Hash, flag bool) bool {
...
func (self *branch) localContains(height uint64, hash common.Hash) bool {
