...
func (self *branchBase) headHH() (uint64, common.Hash) {
	return self.headHeight, self.headHash
}
func (self *branchBase) tailHH() (uint64, common.Hash) {
...
func (self *branchBase) MatchHead(hash common.Hash) bool {
...
func newBranchBase(tailHeight uint64, tailHash common.Hash, headHeight uint64, headHash common.Hash, id string) *branchBase {
	b := &branchBase{}
