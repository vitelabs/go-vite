...
func (self *tree) FindBranch(height uint64, hash common.Hash) Branch {
...
func (self *tree) ForkBranch(b Branch, height uint64, hash common.Hash) Branch {
	if b.Type() == Disk {
...
func (self *tree) Exists(hash common.Hash) bool {
...
func (self *tree) findEmptyForHead(headHeight uint64, headHash common.Hash) *branch {
	self.branchMu.RLock()
